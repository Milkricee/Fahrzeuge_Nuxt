<template>
    <form @submit.prevent="submitForm">
      <div v-if="activeTab === 'Wartungen'" class="space-y-4">
        ...
        <div class="flex flex-col">
          ...
          <textarea v-model="formData.beschreibung"
            class="pl-1 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            rows="3" required
            placeholder="Beschreiben Sie die durchgeführte Wartung"></textarea>
        </div>
        ...
        <div class="flex flex-col">
          <label class="block text-sm font-medium text-gray-700">Nächste Wartung *</label>
          <input type="date" v-model="formData.naechste_wartung"
            class="pl-2 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
            required />
        </div>
